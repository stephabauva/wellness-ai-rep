...
import { useAppContext, Message } from '../context/AppContext'; // Adjusted path
...
export const useChatMessages = () => {
  ...
  return {
    ...
    sendMessageMutation: { mutate: context.sendMessage } as any, // 'as any' is a temporary escape hatch // TODO: RN-Adapt - Review 'as any'
